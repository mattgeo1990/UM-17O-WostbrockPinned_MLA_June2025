...
# JHU data - Tyler use only
R19 = "JHU_Jan2014_TEHhandFormat.xlsx"
R20 = "JHU_Oct2014_TEHhandFormat.xlsx"
R21 = "JHU_Oct2014_2_TEHhandFormat.xlsx"

# Also add variable name here for newly finished reactors
reactor.file.names <-
  # c(R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18)
c(R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21)
...
# for (k in 16) { # use this line to pick one reactor
