...
##2023-3-16
#V09.2 KSA
# Reactor 25 data corrected. 1 segment in this reactor.

##2023-6-30
#V09.2 KSA
# Reactor 26 data corrected. 2 segments in this reactor. Segment starts are IPL-17P-4733 after Fe catalyst change. Script was changed to include 
# standard names on the summarySTD csv files. To do this line "write.csv(summary.std[[k]], curFile.summary.std, row.names = FALSE" was changed from
# FALSE to TRUE. This line is the last line in the section titled "# Output corrected data for all and auto-preferred correction schemes".

##2023-10-12
#V09.2 KSA
# Reactor 27 data corrected. 1 segment in this reactor.

##2023-11-02
#V09.2 KSA
# Reactor 28 data corrected. 1 segment in this reactor.
...
reactor.file.names0 <- c(R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28)
...
formatCount = 0
for (reactor.file.number in 28:28) { # This is the way to only reduce one reactor at a time.
  ...
  if (formatCount == 0){
    ...
    source(paste(path.to.format.func, "ReactorSpreadsheetFormatter_func_v2.R", sep = ""))
  ...
  for (k in 1:length(summary.std)) {
    ...
    write.csv(data.cor.line.stats[[k]],
              ...
              row.names = FALSE)
    write.csv(summary.std[[k]], curFile.summary.std, row.names = TRUE)
  }
