...
for (reactor.file.number in 1) {
  ...
  # Output path
  out.path <-
    "C:/Users/Tyler/Documents/000_Michigan/Laboratory Data Files/Data Reduction Procedure/0002_LabFileCorrectedOutput/Phoebe_20200303/"
  ...
  threshold.rsq = 0.50 # R-squared threshold to use a linear correction for data reduction
  ...
  # if this isn't working, type list.files(path=path.to.nu.data) in the console to see which files are in your working directory and adjust the file name if necessary
  ...
  # Create the overall flag column, which combines flags from flag.analysis and from samples that were not primed correctly.
  ...
  for (dk in 1:nrow(compiled.nu.data)){
    ...
    if (dk == 1){ # first row, nothing to test agains
  ...
  #   curFile.data.cor = paste(out.path,
  #                            "R",
  #                            prefix,
  #                            "_corData_",
  #                            plot.col.byCorr.names[k],
  #                            ".csv",
  #                            sep = "")
  #   curFile.data.cor.line.stats = paste(out.path,
  #                                       "R",
  #                                       prefix,
  #                                       "_corDataLineStats_",
  #                                       plot.col.byCorr.names[k],
  #                                       ".csv",
  #                                       sep = "")
  #   curFile.summary.std = paste(out.path,
  #                               "R",
  #                               prefix,
  #                               "_summaryStd_",
  #                               plot.col.byCorr.names[k],
  ...
  # curFile.data.cor.final = paste(out.path,
  #                                "R",
  #                                prefix,
  #                                "_dataFinal",
  #                                ".csv",
  ...
  # curFile.data.cor.final.line.stats = paste(out.path,
  #                                           "R",
  #                                           prefix,
  #                                           "_dataFinal_lineStats",
  #                                           ".csv",
  #                                           sep = "")
