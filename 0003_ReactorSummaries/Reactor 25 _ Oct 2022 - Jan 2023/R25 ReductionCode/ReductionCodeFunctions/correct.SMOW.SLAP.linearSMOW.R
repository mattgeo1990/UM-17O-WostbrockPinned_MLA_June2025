...
correct.SMOW.SLAP.linearSMOW <- function(D17O.data) {
  ...
  D17O.data.linearSMOW$dp17O.SMOWSLAP <- log((D17O.data.linearSMOW$d17O.slap/1000)+1)*1000
  D17O.data.linearSMOW$dp18O.SMOWSLAP <- log((D17O.data.linearSMOW$d18O.slap/1000)+1)*1000
  D17O.data.linearSMOW$D17O.SMOWSLAP <- D17O.data.linearSMOW$dp17O.SMOWSLAP - slope.MWL*D17O.data.linearSMOW$dp18O.SMOWSLAP
  D17O.data.linearSMOW$D17O.SMOWSLAP.per.meg <- D17O.data.linearSMOW$D17O.SMOWSLAP*1000
